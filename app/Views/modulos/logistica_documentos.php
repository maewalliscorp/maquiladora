...
<script>
    document.addEventListener('DOMContentLoaded', ()=>{
        ...
        if (!SUPABASE_URL || !SUPABASE_ANON || !window.supabase || !window.supabase.createClient) {
            console.warn('Supabase no disponible; sólo podrás capturar la URL/archivo manualmente.');
            return; // sólo afecta a la carga de listas de PDFs
        }
